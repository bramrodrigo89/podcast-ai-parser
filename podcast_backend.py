...
@stub.function(image=corise_image, secret=modal.Secret.from_name("rodrigo-openai-secret"))
def get_podcast_summary(podcast_transcript):
  import openai

  ## ADD YOUR LOGIC HERE TO RETURN THE SUMMARY OF THE PODCAST USING OPENAI
  instructPrompt = """
    What is the main idea of this podcast and who is talking?
  """
...
def get_podcast_guest(podcast_transcript):
  ...
  podcastGuest = {
    "name": podcast_guest,
    "guest_organization": podcast_guest_org,
    "guest_title": podcast_guest_title
  }
...
def get_podcast_highlights(podcast_transcript):
  ...
  instructPrompt = """
    Extract the highlights of the conversation and the main key moments.
  """
  request = instructPrompt + podcast_transcript
  chatOutput = openai.ChatCompletion.create(model="gpt-3.5-turbo-16k",
                                            messages=[{"role": "system", "content": "You are a helpful assistant."},
...
@stub.function(image=corise_image, secret=modal.Secret.from_name("rodrigo-openai-secret"), timeout=1200)
